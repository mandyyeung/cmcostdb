...
class SubcontractorsControllerTest < ActionController::TestCase
  ...
  test "should create subcontractor" do
    assert_difference('Subcontractor.count') do
      post :create, subcontractor: { contract_value: @subcontractor.contract_value, name: @subcontractor.name, trade: @subcontractor.trade }
    end
  ...
  test "should update subcontractor" do
    patch :update, id: @subcontractor, subcontractor: { contract_value: @subcontractor.contract_value, name: @subcontractor.name, trade: @subcontractor.trade }
    assert_redirected_to subcontractor_path(assigns(:subcontractor))
  end
